...
DATA_DIR = "/home/wiss/chenh/storage/group/dataset_mirrors/01_incoming/egoasis4d/hoi4d/HOI4D_release"
...
class HOI4DDataset(Dataset):
    ...
    def _get_frame(self, sample_name, frame_idx):
        ...
        color_video_fpath = os.path.join(self.data_dir, sample, "rgb")
        depth_video_fpath = os.path.join(self.data_dir, sample, "depth")
        traj_video_fpath = os.path.join(self.data_dir, sample, f"dex_traj")
        mask_video_fpath = os.path.join(self.data_dir, sample, "2Dseg/mask")
        ...
        camera_intr_fpath = os.path.join(
            self.data_dir, sample.split("/")[0], "intrinsics.npy"
        )
        ...
        if self.load_hands:
            ...
            visual_history, visual_history_patch, visual_goal, visual_goal_patch = (
    ...
    def _build_visual_feature_history(self, sample_name, frame_idx):
        ...
        visual_observation = (
            visual_feature_data["visual_observation"] + 1
        ) / 5.0  # [T, 196, 768]
...
if __name__ == "__main__":
    ...
    dataset = HOI4DDataset(
        ...
        split_fpath="data/splits/hoi4d_dummy_valid_frame_ranges_w_trajectory.csv",
        horizon=15,
        fps=15,
        load_tracks=True,
        load_hands=True,
